...
public class DeepCloning {
    ...
    public static void main(String[] args) {
        ...
        StudentDeep student = new StudentDeep("Giovanni Giorgio", "X", courses);

        StudentDeep studentClone = null;
        try {
            studentClone = (StudentDeep) student.clone();
         ...
         * Student courses after change: [ Physics, Chemistry, Mathematics, English, Physical Education ]
         */
    }
}
